...
"""autogenerated by genpy from ros_msgs/StringActionResult.msg. Do not edit."""
import codecs
import sys
...
class StringActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "ros_msgs/StringActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_msgs/StringResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StringActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = custom_msgs.msg.StringResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = custom_msgs.msg.StringResult()

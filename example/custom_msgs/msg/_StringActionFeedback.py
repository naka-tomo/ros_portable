...
"""autogenerated by genpy from ros_msgs/StringActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class StringActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "ros_msgs/StringActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_msgs/StringFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StringActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = custom_msgs.msg.StringFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = custom_msgs.msg.StringFeedback()
